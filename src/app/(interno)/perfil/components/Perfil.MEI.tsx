...
export default function PerfilMEI() {
  return (
    <div className="p-8 max-w-4xl mx-auto bg-white rounded-xl shadow-md">
      <h1 className="text-3xl font-bold mb-6 text-violet-900">Perfil MEI</h1>
      <div className="bg-violet-50 p-6 rounded-lg mb-6">
        ...
        <div className="space-y-4">
          <p className="text-gray-700">
            Tipo de Perfil: <span className="font-semibold">MEI</span>
          </p>
          <p className="text-gray-700">
            Status:{" "}
