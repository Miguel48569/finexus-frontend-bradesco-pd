...
export default function ContratosMEI() {
  return (
    <div className="p-8 max-w-4xl mx-auto bg-white rounded-xl shadow-md">
      <h1 className="text-3xl font-bold mb-6 text-violet-900">Contratos MEI</h1>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-white rounded-lg shadow">
            <p className="text-gray-700">
              Tipo de Contrato: <span className="font-semibold">MEI</span>
            </p>
            <p className="text-gray-700">
              Status:{" "}
